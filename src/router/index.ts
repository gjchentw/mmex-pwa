...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/payees', component: () => import('../views/PayeesView.vue') },
    { path: '/tags', component: () => import('../views/TagsView.vue') },
    { path: '/custom-fields', component: () => import('../views/CustomFieldsView.vue') },
    { path: '/date-ranges', component: () => import('../views/DateRangesView.vue') },
